(function (root, factory) {
  ...
  const TEXT = {
    ja: {
      ...
      bgProbeStatusLabel: 'BGプローブ',
      statusEnabled: '有効',
      statusDisabled: '無効',
      statusNeverRun: '未実行',
      statusLastRun: function (date) { return '最終 ' + date; },
      statusNextRun: function (date) { return '次回 ' + date; },
      statusProgress: function (done, total) { return '今サイクル ' + done + '/' + total + ' 照会済み'; },
      statusBreakdown: function (next, discount) { return '続刊 ' + next + '件 / 値引き ' + discount + '件'; },
      popupAutomationStatus: function (autoText, bgText) { return '自動: ' + autoText + ' ／ BG: ' + bgText; },
      days3: '3日',
      days7: '7日',
      days14: '14日',
      hours12: '12時間',
    ...
    en: {
      ...
      bgProbeStatusLabel: 'BG probe',
      statusEnabled: 'Enabled',
      statusDisabled: 'Disabled',
      statusNeverRun: 'Never run',
      statusLastRun: function (date) { return 'Last ' + date; },
      statusNextRun: function (date) { return 'Next ' + date; },
      statusProgress: function (done, total) { return 'Cycle ' + done + '/' + total + ' checked'; },
      statusBreakdown: function (next, discount) { return 'Next ' + next + ' / Discount ' + discount; },
      popupAutomationStatus: function (autoText, bgText) { return 'Auto: ' + autoText + ' / BG: ' + bgText; },
      days3: '3 days',
      days7: '7 days',
      days14: '14 days',
      hours12: '12 hours',
