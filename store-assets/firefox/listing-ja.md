...
- Zip: `dist/firefox/kindle-series-sale-tracker-firefox-v0.1.0.zip`
- Version: `0.1.0`
...
- Amazon.co.jp Kindle蔵書一覧の手動スキャン
- シリーズ候補、所有巻レンジ、欠番候補の表示
- 続刊候補、価格、割引率、発売日の確認
- CSV / JSON エクスポート
- Firefoxサイドバー対応
```
...
```text
Amazon.co.jpのKindle蔵書ページから蔵書一覧を取得し、Amazon.co.jp検索結果から続刊候補・価格・割引率を確認するために使用します。対象はこの拡張機能の表示機能に必要なAmazon.co.jp内のページに限定しています。他のWebサイトへのアクセス権限は要求していません。
```
